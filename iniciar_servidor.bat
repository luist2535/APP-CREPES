...
echo [3] Actualizar Servidor (Descargar cambios de GitHub y recompilar)
echo [4] Guardar Cambios (Subir modificaciones locales a GitHub)
echo.
set /p modo="Ingresa 1, 2, 3 o 4 y presiona ENTER: "

if "%modo%"=="1" goto run_prod
if "%modo%"=="2" goto run_dev
if "%modo%"=="3" goto run_git_pull
if "%modo%"=="4" goto run_git_push
goto menu
...
if errorlevel 1 goto build_error
echo ========================================================================
echo ¡Servidor actualizado con exito!
echo Vuelve a iniciar el servidor en Modo Produccion [1].
echo ========================================================================
goto end

:run_git_push
:: MODO GUARDAR GIT PUSH
echo.
echo ========================================================================
...
call git add -A
call git commit -m "Actualizacion desde servidor local %DATE%"
call git push origin main
if errorlevel 1 goto push_error
echo ========================================================================
echo ¡Cambios guardados en GitHub con exito!
echo ========================================================================
goto end
...
color 0C
echo ========================================================================
echo [ERROR] GIT NO ESTA INSTALADO EN ESTE SERVIDOR
echo ========================================================================

...
echo    ----------------------------------------------------------
echo     Node: %S_NODE%   NPM: %S_NPM%   Git: %S_GIT%   Deps: %S_DEPS%   BD: %S_DB%
echo    ----------------------------------------------------------
echo.
echo                      MENU PRINCIPAL
echo    ----------------------------------------------------------
...
echo    ==========================================================
echo.
echo      Salida detallada guardada en: startup_log.txt
echo    ----------------------------------------------------------
echo.
...
:: --- Paso 4: Build ---
echo        [4/5] Compilando aplicacion (2-5 min)...
...
echo        [2/3] Instalando nuevas dependencias...
call npm install
echo              [OK] Dependencias actualizadas.
echo.

echo        [3/3] Recompilando aplicacion...
echo.
call npm run build
if errorlevel 1 (
    echo.
    echo        [ERROR] Error al compilar. Revisa los errores.
    goto pause_menu
)
echo.
echo    ==========================================================
...
if errorlevel 1 (
    ...
    echo        Verifica conexion y credenciales.
    goto pause_menu
)
echo.
echo    ==========================================================
...
echo    ==========================================================
echo.
echo      Revisa los errores en: startup_log.txt
goto pause_menu

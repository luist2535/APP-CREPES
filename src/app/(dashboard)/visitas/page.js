                          ...
                          <tbody>
                            <tr>
                              <td style={{ width: '22%', borderRight: '1.5px solid #2C1810', padding: '8px', textAlign: 'center', verticalAlign: 'middle', backgroundColor: '#faf6f2' }}>
                                <img src="/images/logo-crepes-round-brown.png" alt="Logo" style={{ maxHeight: '42px', objectFit: 'contain', display: 'block', margin: '0 auto 4px auto' }} onError={(e) => { e.target.style.display = 'none'; }} />

...
try {
  ...
  db.transaction(() => {
    ...
    insertEquipo.run('RCSUIBZ1412230144', 'Terminal POS Touch Screen', 'NCR / Elo Touch', 'POS-15-Capacitivo', 'SER-RCS-141223', 1, '{"procesador":"Intel Core i5","memoria":"8GB DDR4","almacenamiento":"256GB SSD","pantalla":"15 pulgadas táctil","sistema_operativo":"Windows 10 IoT Enterprise","uso":"Caja Registradora / Toma de Pedidos"}', '2026-06-01', '2026-09-01');
  })();
